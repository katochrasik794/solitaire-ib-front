        ...
        <div className="flex flex-col space-y-4">
          ...
          <Card className="bg-white border border-gray-200">
            ...
            <div className="text-center">
              ...
              <div className="w-8 h-8 bg-brand-100 rounded-full flex items-center justify-center mx-auto">
          ...
          <Card className="bg-white border border-gray-200">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex gap-1.5">
                <button
                  ...
                  className={`px-2.5 py-1 text-xs rounded font-medium transition-colors ${activeTab === 'link'
                ...
                <button
                  ...
                  className={`px-2.5 py-1 text-xs rounded font-medium transition-colors ${activeTab === 'code'
                    ? 'bg-brand-500 text-dark-base'
                    : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50'
                    }`}
                >
            ...
            <div className="flex items-center justify-center gap-2 mb-2 px-8 relative">
              <p className="text-xs text-brand-700 underline break-all text-center flex-1">
                {loading ? 'Loading...' : activeTab === 'link' ? getCrmReferralLink() : (dashboardData?.referralCode || 'YOUR_CODE')}
              </p>
              {!loading && (
                <button
                  onClick={handleEditReferralCode}
                  className="flex-shrink-0 p-1.5 text-brand-700 hover:text-brand-800 hover:bg-brand-50 rounded transition-colors"
            ...
            <div className="flex justify-center gap-2">
              <button
                className="inline-flex items-center gap-1 px-2.5 py-1 bg-brand-500 text-dark-base rounded text-xs font-medium hover:bg-brand-600 transition-colors"
          ...
          <Card className="bg-white border border-gray-200">
            ...
            <div className="text-center">
              <p className="text-xs text-gray-600">
                <span
                  className="text-brand-700 underline cursor-pointer"
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <FiStar className="h-4 w-4 text-brand-600" />
                </div>
                <button
                  className="px-2.5 py-1 bg-brand-500 hover:bg-brand-600 text-dark-base font-medium text-xs rounded-md flex items-center gap-1.5 flex-shrink-0"
                ...
                {loading ? (
                  ...
                  dashboardData.commissionStructures.slice(0, 2).map((struct, idx) => (
                    <div key={idx} className="flex flex-col">
                      <span className="text-3xl font-bold text-brand-700 underline">{struct.spreadShare || 0}%</span>
                      <span className="text-xs text-gray-600 mt-0.5">{struct.name}</span>
                    </div>
                  ))
                ) : (
                  <div className="flex flex-col">
                    <span className="text-3xl font-bold text-brand-700 underline">0%</span>
              ...
              <div className="mb-4">
                <button
                  className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-brand-500 text-dark-base rounded-md text-xs font-medium hover:bg-brand-600"
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-1.5 cursor-pointer">
                  ...
                  <span className="text-xs text-brand-700 font-medium underline">18 Days left</span>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-brand-600">
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-medium text-brand-700 underline cursor-pointer">Trading volume</span>
                    <span className="text-xs text-gray-600">0 / 15 mln USD</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 bg-brand-400 rounded-full flex-shrink-0"></div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-medium text-brand-700 underline cursor-pointer">Active clients</span>
        ...
        {showLoyaltyDetails && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                {/* Target 1 */}
                <div className="border-2 border-dashed border-brand-300 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mb-2">
                Your total volume: <span className="font-semibold text-brand-700">{totalVolumeMln.toFixed(2)} MLN USD</span>
              </p>
              ...
              <div className="space-y-3 mb-4 max-h-96 overflow-y-auto">
                {rewards.map((reward) => {
                  ...
                  return (
                    <div key={reward.id} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg hover:border-brand-300 transition-colors">
                      ...
                      <div className="flex-shrink-0">
                        {status.status === 'claimed' ? (
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 bg-brand-500 hover:bg-brand-600 text-dark-base rounded-lg text-xs font-medium transition-colors"
                          >
                            Claim
                          </button>
                        ) : (
                      ...
                      <div key={claim.id} className="flex items-center gap-3 p-2 bg-green-50 border border-green-200 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-600">
                            ...
                            Status: <span className={`font-medium ${claim.status === 'approved' ? 'text-green-600' :
              ...
              <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    maxLength={8}
                    disabled={updatingReferralCode}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 px-4 py-2 bg-brand-500 hover:bg-brand-600 text-dark-base rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
